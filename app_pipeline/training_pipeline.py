...
import os
import sys
from app_entity.artifact_entity import DataIngestionArtifact, ModelTrainerArtifact, DataValidationArtifact,\
...
from app_src.stage_04_model_evaluation import ModelEvaluation
from app_src.stage_05_model_pusher import ModelPusher

training_pipeline_logger = App_Logger(__name__)
...
class TrainingPipeline:
    ...
    def start_training_pipeline(self):
        try:
            training_pipeline_logger.info("Starting training pipeline")
            ...
            training_pipeline_logger.info("Training pipeline completed")
